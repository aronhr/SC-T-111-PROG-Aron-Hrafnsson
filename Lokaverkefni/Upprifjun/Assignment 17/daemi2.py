...
The class should have __str__ method to return a string for output using this format:
"{:<20s} {:<20s}". Lastly, it has the following method to set guitarist and guitar:
